...
if (!function_exists('PageInserter')) {
    ...
    function PageInserter($result, $batch = 0, $existing_id = null) {
        ...
        if ($existing_id == null) {
            ...
            PageTranslation::create(['page_id' => $page_id, 'lang_id' => 1, 'title' => $result->title, 'introduction' => $result->introduction, 'conclusion' => $result->conclusion, 'org_introduction' => $result->introduction, 'org_introduction' => $result->conclusion]);
