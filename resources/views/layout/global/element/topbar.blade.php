<header>
    <div class="container relative h-[66px] flex items-center">
        ...
        <ul class="h-[66px] ms-auto flex items-center [&>li]:ms-6">
            <li>
                <a href="{{ route('search') }}" class="flex items-center justify-center w-9 h-9 rounded-full ring-2 ring-slate-300 hover:ring-slate-400 bg-slate-50" title="{{ __('common.topbar.search') }}">
            ...
            <li>
                <label for="language" class="block cursor-pointer" title="{{ __('common.topbar.language') }}">
