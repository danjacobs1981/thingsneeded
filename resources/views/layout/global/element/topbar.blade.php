<header>
    <div class="container relative h-[66px] flex items-center">
        <a href="{{ route('home') }}" class="flex items-center absolute top-0 left-0 px-4 sm:px-8 xl:px-4 2xl:px-8 min-h-[72px] me-28 min-w-52" title="{{ __('website.topbar.logo') }}">
        ...
        <ul class="h-[66px] ms-auto flex items-center [&>li]:ms-4 lg:[&>li]:ms-6 z-10">
            <li>
            ...
            <li>
                ...
                <ul class="absolute top-[66px] right-4 sm:right-8 xl:right-4 2xl:right-8 ring-1 ring-inset ring-slate-300 shadow-md rounded-lg p-4 bg-white hidden peer-checked/language:grid gap-1.5">
